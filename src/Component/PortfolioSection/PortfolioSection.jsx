...
export const portfolioItems = [
  {
    ...
    about2:
      "Trigun Studio offers exceptional interior design that seamlessly blends creativity with functionality. We ensure that every space is visually stunning and highly practical. We specialize in residential and commercial project designs.",
  ...
  },
  {
    ...
    about:
      "Design Roots, based in Jalahalli, Bangalore, is a leading name in India’s additive manufacturing sector. We offer a full spectrum of services, including rapid prototyping, reverse engineering, CNC machining, vacuum casting, and molding, ensuring functional, reliable, and production-ready parts across India.",
    about2:
      "Catering to both established industries and startups, we serve sectors such as automotive, electronics, healthcare, aerospace, education, jewelry making, and consumer goods.",
    service: [
      "3D printing",
      "Vacumm Casting Machine",
      "CNC Machining,Injection modeling",
    ],
  ...
  },
  {
    ...
    about:
      "At Industro Venture, we are leading the transformation of education by blending cutting-edge technology with community-driven passion. Our focus is on redefining how education meets industry, creating pathways where students excel, institutions grow, and innovation thrives.",
    about2:
      "To inspire and empower the next generation with the skills, resources, and environments needed to lead in a rapidly evolving world.",
    service: [
      "Corporate Training",
  ...
  },
  {
    ...
    about:
      "Quality with high-end technology gives our customers total value for their money. Quality is a way of life. We pack quality and luxury into every square foot of construction.",
    about2:
      "Our success as a real estate builder has been built on the personal referral of business from past satisfied clients, tenants, and landlords, together with our outstanding reputation and credibility.",
    service: [
      "available to impartial",
      "unbiased people",
      "culture",
      "social background",
    ],
  ...
  },
  {
    ...
    about:
      "Keva is Coimbatore's best Skin and hair care clinic. Our skilled team specializes in skin lightening, tightening, and acne treatments, along with advanced hair loss and Hair PRP treatments. As the top skin and hair care clinic in Coimbatore, we take pride in offering expert services tailored to your individual needs.",
    about2:
      "Our dermatologists provide personalized guidance and use advanced techniques to ensure the best outcomes for your Skin and hair.",
    service: [
  ...
  },
  {
    ...
    about:
      "Established in 2011, BlueStone is India leading destination for high quality fine jewellery with strikingly exquisite designs. We aim at revolutionizing the fine jewellery and lifestyle segment in India with a firm focus on craftsmanship, quality and customer experience. In a short span of time, BlueStone has built a large family of loyal consumers in India and abroad.",
    about2:
  ...
  },
  {
    ...
    about:
      "Candere started off as a digital start-up with the vision of making the luxury of diamonds accessible and attainable for the modern consumer. What began as an online platform quickly evolved into a beloved e-commerce brand, celebrated for its stylish and contemporary designs offered at an affordable price point.",
    about2:
      "Kalyan Jewellers, a name synonymous with trust in the Indian jewellery industry, acquired Candere in 2017.This strategic partnership allowed Candere to expand its operations across more postcodes, bringing our distinctive collections closer to customers across the nation and beyond.",
    service: ["Rings", "Earings", "Bangles"],
    loc: "19, Sivathangam Nagar,Vilankurichi Road,Coimbatore - 641035",
  },
  {
  ...
  },
  {
    ...
    about:
      "NobuyRent is a cutting-edge online rental platform that is transforming the rental economy landscape. NobuyRent offers distinctive solution for:",
    about2:
      "Owners to monetize less frequently used items, turning belongings into earnings.",
    service: [
  ...
  },
  {
    ...
    about:
      "At Mohan Jewellery, every piece is a masterpiece, crafted with precision and passion by our team of expert craftsmen. We are your one-stop destination for a wide range of jewellery designs and pieces including earrings, bangles, necklaces and chains made of gold, diamond, gemstones and platinum. Additionally, you will get to explore our unique offerings such as couple jewellery, rare gemstones, and exquisite silver wares, all available to cater to your every desire. ",
    about2:
      "Our jewellery sets are not just adorned with exquisite stones like Diamonds, Sapphires, Rubies, and Emeralds; it’s a reflection of our commitment to quality and perfection. Each jewellery set undergoes a rigorous grading process, ensuring only the finest stones grace our creations",
    service: ["Rings", "Earings", "Bangles"],
      ...
      <div className="work-holder" ref={revealSectionRef}>
        ...
        <section className="work">
          {Array.from({ length: Math.ceil(portfolioItems.length / 2) }).map(
            (_, rowIndex) => (
              <div
                className={`portfolio-row row${rowIndex + 1} w-layout-grid`}
                key={rowIndex}
              >
                {portfolioItems
